(function() { // IIEF
            ...
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    ...
                    <input
                        type="text"
                        name="tarea"
                        placeholder="${tarea.nombre ? 'Edita el Nombre de la Tarea' : 'Añadir Tarea al Proyecto Actual'}"
                        id="tarea"
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        ...
        // Inserta la alerta entre campo y legend
    ...
    async function agregarTarea(tarea) {
        ...
        try {
            ...
            if(resultado.tipo === 'exito') {
                ...
                // agregar el obj de tarea al blobal de tareas
                const tareaObj = {
